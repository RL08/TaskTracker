...
FRONTEND="$(pwd)/TaskTrackerProject.Client"             # to build the spa with npm run build
SSL_CERT_FILE="TaskTracker.pfx"                  # generated with dotnet dev-certs in this script
DOCKER_IMAGE=tasktracker_app
SQL_IMAGE=TaskTracker_sqlserver
# Use INTERNAL port for the communication inside the docker network (1433 not 11433)
CONN_STR="Server=10.0.38.3,1433;Initial Catalog=TaskTrackerDb;User Id=sa;Password=SqlServer2019;TrustServerCertificate=true"
